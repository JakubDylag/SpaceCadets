...
public class BareBones {
	...
	private static Stack<Integer> callStack = new Stack<>();	//every endFunc Statment, pop last stack, goto line after
	private static List<String> allLines;
	private static HashMap<Integer, Integer> loops; //<END, START>
	private static HashMap<String, Integer> functionDefinitions;
	...
	public static HashMap<Integer, Integer> precompileLoops() {
